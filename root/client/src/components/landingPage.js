...
export const LandingPage = () => {
  ...
  return (
    <div>
      ...
      <main>
        <div id='div-hero'>
          <img id='img-hero' src='/heroImage.png' alt='4 people talking to each other' />
          <div>
        ...
        <div id='div-steps'>
          <ul id='list-workflow-steps'>
            <li>
              ...
              <div>Insert Filling out form here.</div>
            </li>
            <li>
              <h2>2: Share with peers</h2>
              <div>Insert Image</div>
            </li>
            <li>
              <h2>3: Find the ideal meeting time</h2>

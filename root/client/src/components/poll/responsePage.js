...
export const ResponsePage = () => {
  ...
  const handleMobileBtn = (e) => {
    e.preventDefault();
    if (listMobileDescription.current.classList.contains('hide')) {
  ...
  return (
    <div>
      <header>
        ...
        <h2>{name}</h2>
        <div id='header-description' className='hide'>
        ...
        <div id='header-mobile-description'>
          <button id='btn-mobile-description' onClick={handleMobileBtn}>
            <svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512"><path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"/></svg>
          </button>
          <ul id="ul-mobile-poll-description" ref={listMobileDescription}>
            {description && 
              <li>
                <svg id="svg-mobile-description" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 448 512"><path d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H288V368c0-26.5 21.5-48 48-48H448V96c0-35.3-28.7-64-64-64H64zM448 352H402.7 336c-8.8 0-16 7.2-16 16v66.7V480l32-32 64-64 32-32z"/></svg>
                {description}
              </li>}
            {location &&
              <li>
                <svg id="svg-mobile-location" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 384 512"><path d="M384 192c0 87.4-117 243-168.3 307.2c-12.3 15.3-35.1 15.3-47.4 0C117 435 0 279.4 0 192C0 86 86 0 192 0S384 86 384 192z"/></svg>
                {location}
              </li>}
          </ul>
        </div>
